...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<spree_sample>, ["= 3.0.0"])
      s.add_runtime_dependency(%q<spree_cmd>, ["= 3.0.0"])
    else
      ...
      s.add_dependency(%q<spree_sample>, ["= 3.0.0"])
      s.add_dependency(%q<spree_cmd>, ["= 3.0.0"])
    end
  else
    s.add_dependency(%q<spree_core>, ["= 3.0.0"])
    s.add_dependency(%q<spree_api>, ["= 3.0.0"])
